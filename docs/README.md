...
This documentation is organized as a guided systems-architecture reading flow rather than a flat feature list.
...
4. [Memory Lifecycle](./memory-lifecycle.md)
5. [Orchestration Philosophy](./orchestration-philosophy.md)
6. [Architectural Invariants](./architectural-invariants.md)
